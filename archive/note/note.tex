...
fluctuates by 9.5\,\% of the local mean at $W = 30$, falling to
2.0\,\% at $W = 1920$ (Figure~1). The decay is close to but slower than the
$1/\sqrt{W}$ that independent draws would give: fitted over this range it goes as
$W^{-0.38}$, so 64 times the draws bought a factor 4.8 rather than 8. Draws are
